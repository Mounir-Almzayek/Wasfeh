...
class PatientPrescriptionScreen extends StatefulWidget {
  ...
  const PatientPrescriptionScreen({super.key, required this.prescriptionId, required this.token});
      ...
      'medicines': (data['prescription_items'] as List).map((item) {
        return {
          ...
          'details': [
            ...
            {
              'title': 'Next Reminder:',
              'subtitle': 'Reminder to take the next dose at 2:00 PM',
            },
          ],
        };
      }).toList(),
              ...
              children: [
                ...
                Container(
                  ...
                  child: QRWidget(
                    ...
                    Status: int.tryParse(prescription!['purchased'].toString()) == 0,
                  ),
                ),
                Container(
                  margin: EdgeInsets.fromLTRB(20.w, 20.h, 20.w, 0.h),
